...
def result(login, password, image, test):
    ...
    data2.append([1, 0,test[0],"Leadership"])
    data2.append([1, 1,test[0],"Management"])
    data2.append([1, 2,test[1],"Problem Solving"])
    data2.append([1, 3,test[1],"Decision Making"])
    data2.append([1, 4,test[2],"Listening"])
    data2.append([1, 5,test[2],"Speaking"])
    data2.append([1, 6,test[3],"Self-Confidence"])
    data2.append([1, 7,test[3],"Positive-thinking"])
    data2.append([1, 8,test[4],"Prioritisation"])
    data2.append([1, 9,test[4],"Scheduling"])
